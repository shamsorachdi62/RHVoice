...
class nsis_bootstrapper_packager(windows_packager):
	def __init__(self,name,outdir,env,display_name,version):
		...
		self.languages=[
			"English", "Russian", "Portuguese", "Esperanto", "Georgian", "Tatar", "Ukrainian", "Macedonian", "Albanian", "Polish", "Uzbek", "Serbian", "Spanish", "Croatian", "Slovak", "Czech", "German", "French", "Luxembourgish", "Romanian", "Belarusian"
		]
		self.add_includes()
		self.add_settings()
